<!-- Wersja działająca opracowana na podstawie przykładu : https://learn.microsoft.com/en-us/azure/azure-maps/map-add-pin -->
    ...
    <script type="text/javascript">
        ...
        function InitMap()
        {
            ...
            map.events.add('ready', function () {
                ...
                var point = new atlas.Shape(new atlas.data.Point(<?php echo json_encode ( $youngest_location["coordinates"] ) ; ?>));
